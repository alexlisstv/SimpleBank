"""
Shared Django settings for SimpleBank (loaded by dev / prod).
"""
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgresql://simplebank:simplebank@127.0.0.1:5432/simplebank",
    )
}
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Banking-style REST API: registration, balances, transactions, transfers.",
    "VERSION": "1.0.0",
